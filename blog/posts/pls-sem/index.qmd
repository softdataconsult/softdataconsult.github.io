...
The GitHub repository is [here](https://github.com/softdataconsult/blog/posts/pls-sem).
You can follow me on [Twitter](https://twitter.com/seyiajao) and [Linkedin](https://www.linkedin.com/in/isaac-oluwaseyi-ajao-datascientist-dataanalyst-statistician-consultant/) for more updates on `R`, `Python`, `STATA` and `Excel` for data science.
